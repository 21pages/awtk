...
static inline void mem_entry_dump(void) {
  ...
  log_info("mem_info: used_block=%u used_size=%u <8=%u <16=%u <32=%u >1024=%u >10240=%u >102400=%u\n",
      used_block, used_size, leq8, leq16, leq32, geq1024, geq10240, geq102400);

  return;
}


static inline void* mem_allocator_debug_alloc(mem_allocator_t* allocator, uint32_t size, const char* func, uint32_t line) {
  void* addr = NULL;
...
static inline mem_allocator_t* mem_allocator_debug_create(mem_allocator_t* impl) {
